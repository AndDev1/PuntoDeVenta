...
public class WeekDemo extends JPanel {
	...
	private JMonth createMonth() {
		...
		mv.setColumns(1);
		mv.getWeekModel().setSelectedDow(mv.getMonth(), Calendar.WEDNESDAY);
...
//		return mv;
	...
	private JPanel createWeekNumbersPanel() {
		...
		final JCheckBox isoWeekNumbersEnabled = new JCheckBox("ISO Week Numbers Enabled", month.isISOWeekNumbers());
		isoWeekNumbersEnabled.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				month.setISOWeekNumbers(isoWeekNumbersEnabled.isSelected());
			}
		});
