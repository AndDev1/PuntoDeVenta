...
public class SuiteDemo extends JPanel {
	...
	public SuiteDemo() {		
		...
		toDatePicker.getPopup().getMonthView().setTitleBackground(new Color(255, 170, 0));
		toDatePicker.getPopup().getMonthView().setMonthBackground(new Color(255, 231, 186));
		
		executeLabel = new JLabel("Launch at:");
		executeDateField = new JDateField();
		executeDateField.setDateFormat("h:mm a");
