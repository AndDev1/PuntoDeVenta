...
/**
 * <p>A data-aware subclass of <code>JDateField</code>. It adds the following 
 * properties:</p>
 * 
 * <ul>
 ...
 * </ul>
 * 
 * <p><code>JdbDateField</code> sets its <code>background</code>, <code>foreground</code>, 
 ...
 * explicitly set on the <code>JdbDateField</code> itself.</p>
 * 
 * @see DBDateEditComponentDataBinder
 */
public class JdbDateField extends JDateField implements DBDataBinder, ColumnAware, java.io.Serializable {
	/**
